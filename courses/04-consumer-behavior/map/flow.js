 ...
 * 얼개:
 *
 *   가운데 줄은 교수가 그린 흐름에 태도를 되살린 것이다.
 *   M·A·O → 노출·주의·지각·이해 → 지식·기억·인출 → 태도 → 구매 → 구매후행동.
 *   지식·기억에서 곧장 구매로 가면 "그래서 좋다고 여기게 됐나"가 빠진다.
 *   게다가 태도는 고노력·저노력 갈림이 처음 드러나는 자리라, 감추면 같은
 *   갈림이 두 번 나온다는 이 과목의 뼈대가 보이지 않는다.
 *
...
const MAIN = [
  { id: "mao", ab: "M·A·O", orb: "M·A·O", s: "동기·능력·기회", ch: "2장", tone: 1,
    ...
    note: "첫 칸이면서 스위치다. 태도(5·6장)와 의사결정(7~9장)이 여기서 "
        + "고노력과 저노력으로 갈린다. 같은 갈림이 두 번 나오는 것이 이 과목의 뼈대다." },
  ...
  { id: "att", ab: "5·6장", orb: "태도", s: "태도 형성과 변화", ch: "5·6장", tone: 1,
    en: "attitude formation and change",
    hi: "5장 고노력", lo: "6장 저노력",
    say: "좋다 싫다가 생기고 바뀐다. 기억에 쌓인 것이 곧바로 구매로 가지 않는다 — "
       + "그 사이에 '이건 좋다'는 판이 서야 한다. M·A·O 의 갈림이 여기서 처음 드러난다. "
       + "따져 가며 만드는 태도(5장)와 그냥 익숙해서 생기는 태도(6장)는 다른 길을 탄다.",
    note: "여기까지가 마음(심리적 핵심 요소)이고, 다음 칸부터가 선택(의사결정)이다." },

  { id: "buy", ab: "7~9장", orb: "구매", s: "문제인식 · 탐색 · 의사결정", ch: "7~9장", tone: 2,
    en: "problem recognition · search · judgment · decision",
    hi: "8장 고노력", lo: "9장 저노력",
    say: "고르는 자리. 지금과 바라는 바가 벌어져 있음을 알아채고 찾아 나선 뒤(7장), "
       + "고른다(8·9장). M·A·O 의 갈림이 두 번째로 드러난다 — 견주어 따져 고르기와 "
       + "어림으로 집기는 아주 다르게 움직인다. 장바구니의 대부분은 뒤쪽이다." },
    ...
    '<div class="top">' +
      ...
      '<div class="map">' +
        ...
        '<div class="core">' +
          ...
          '<p class="rule"><b>M·A·O</b> 가 <b>태도</b>와 <b>구매</b>를 ' +
            "고노력 · 저노력으로 가른다 — 같은 갈림이 두 번 나온다</p>" +
        "</div>" +
